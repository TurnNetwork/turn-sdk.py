...
def parse_block_identifier(
    ...
    if isinstance(block_identifier, int):
        ...
        return w3.bub.get_block(block_identifier)["number"]
    else:
...
def parse_block_identifier_int(w3: "Web3", block_identifier_int: int) -> BlockNumber:
    if block_identifier_int >= 0:
        ...
        last_block = w3.bub.get_block("latest")["number"]
...
async def async_parse_block_identifier(
    ...
    if block_identifier is None:
        return async_w3.bub.default_block
    if isinstance(block_identifier, int):
        ...
        requested_block = await async_w3.bub.get_block(block_identifier)
...
async def async_parse_block_identifier_int(
    ...
    if block_identifier_int >= 0:
        ...
        last_block = await async_w3.bub.get_block("latest")
