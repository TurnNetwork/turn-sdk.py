...
if TYPE_CHECKING:
    ...
    from bubble.contract import Contract  # noqa: F401
...
class AsyncBubModuleTest:
    @pytest.mark.asyncio
    async def test_bub_gas_price(self, async_w3: "AsyncWeb3") -> None:
        gas_price = await async_w3.bub.gas_price
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_legacy(
        ...
        txn_params: TxParams = {
            ...
            "value": Wei(1),
            "gas": 21000,
            "gasPrice": await async_w3.bub.gas_price,
        }
        txn_hash = await async_w3.bub.send_transaction(txn_params)
    ...
    @pytest.mark.asyncio
    async def test_bub_modify_transaction_legacy(
        ...
        modified_txn_hash = await async_w3.bub.modify_transaction(
            txn_hash, gasPrice=(cast(int, txn_params["gasPrice"]) * 2), value=2
        )
        modified_txn = await async_w3.bub.get_transaction(modified_txn_hash)
    ...
    @pytest.mark.asyncio
    async def test_bub_modify_transaction(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_sign_transaction(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
        ...
        result = await async_w3.bub.sign_transaction(txn_params)
        signatory_account = async_w3.bub.account.recover_transaction(result["raw"])
    ...
    @pytest.mark.asyncio
    async def test_async_bub_sign_transaction_legacy(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_sign_transaction_hex_fees(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    async def test_async_bub_sign_transaction_ens_names(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        with ens_addresses(async_w3, {"unlocked-account.bub": unlocked_account}):
            txn_params: TxParams = {
                "from": "unlocked-account.bub",
                "to": "unlocked-account.bub",
                "value": Wei(1),
                "gas": 21000,
                "maxFeePerGas": async_w3.to_wei(2, "gwei"),
                "maxPriorityFeePerGas": async_w3.to_wei(1, "gwei"),
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_default_fees(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_hex_fees(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_no_gas(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_with_gas_price(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        with pytest.raises(TransactionTypeMismatch):
            await async_w3.bub.send_transaction(txn_params)

    @pytest.mark.asyncio
    async def test_bub_send_transaction_no_priority_fee(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_no_max_fee(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bub_send_transaction_max_fee_less_than_tip(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    async def test_validation_middleware_chain_id_mismatch(
        ...
        actual_chain_id = await async_w3.bub.chain_id
    ...
    @pytest.mark.asyncio
    async def test_node_poa_middleware(self, async_w3: "AsyncWeb3") -> None:
        return_block_with_long_extra_data = (
            await async_construct_result_generator_middleware(
                {
                    RPCEndpoint("bub_getBlockByNumber"): lambda *_: {
                        "extraData": "0x" + "ff" * 33
                    },
                }
            )
        )
        async_w3.middleware_onion.inject(async_node_poa_middleware, "poa", layer=0)
    ...
    @pytest.mark.asyncio
    async def test_bub_send_raw_transaction(self, async_w3: "AsyncWeb3") -> None:
        ...
        txn_hash = await async_w3.bub.send_raw_transaction(raw_txn)
    ...
    async def test_gas_price_strategy_middleware(
        ...
        async_w3.bub.set_gas_price_strategy(None)  # reset strategy
    ...
    @pytest.mark.asyncio
    async def test_bub_estimate_gas(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        gas_estimate = await async_w3.bub.estimate_gas(
            {
                "from": unlocked_account_dual_type,
                "to": unlocked_account_dual_type,
                "value": Wei(1),
    ...
    @pytest.mark.asyncio
    async def test_bub_fee_history(self, async_w3: "AsyncWeb3") -> None:
        fee_history = await async_w3.bub.fee_history(1, "latest", [50])
    ...
    @pytest.mark.asyncio
    async def test_bub_fee_history_with_integer(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        fee_history = await async_w3.bub.fee_history(1, empty_block["number"], [50])
        assert is_list_like(fee_history["baseFeePerGas"])
        assert is_list_like(fee_history["gasUsedRatio"])
        assert is_integer(fee_history["oldestBlock"])
        assert fee_history["oldestBlock"] >= 0
    ...
    @pytest.mark.asyncio
    async def test_bub_fee_history_no_reward_percentiles(
        self, async_w3: "AsyncWeb3"
    ) -> None:
        fee_history = await async_w3.bub.fee_history(1, "latest")
        assert is_list_like(fee_history["baseFeePerGas"])
        assert is_list_like(fee_history["gasUsedRatio"])
        assert is_integer(fee_history["oldestBlock"])
        assert fee_history["oldestBlock"] >= 0
    ...
    @pytest.mark.asyncio
    async def test_bub_max_priority_fee(self, async_w3: "AsyncWeb3") -> None:
        max_priority_fee = await async_w3.bub.max_priority_fee
        assert is_integer(max_priority_fee)

    @pytest.mark.asyncio
    async def test_bub_max_priority_fee_with_fee_history_calculation(
        self, async_w3: "AsyncWeb3"
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bub_getBlockByHash(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        block = await async_w3.bub.get_block(empty_block["hash"])
        assert block["hash"] == empty_block["hash"]

    @pytest.mark.asyncio
    async def test_bub_getBlockByHash_not_found(self, async_w3: "AsyncWeb3") -> None:
        with pytest.raises(BlockNotFound):
            await async_w3.bub.get_block(UNKNOWN_HASH)

    @pytest.mark.asyncio
    async def test_bub_getBlockByHash_pending(self, async_w3: "AsyncWeb3") -> None:
        block = await async_w3.bub.get_block("pending")
        assert block["hash"] is None

    @pytest.mark.asyncio
    async def test_bub_getBlockByNumber_with_integer(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        block = await async_w3.bub.get_block(empty_block["number"])
        assert block["number"] == empty_block["number"]

    @pytest.mark.asyncio
    async def test_bub_getBlockByNumber_latest(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        current_block_number = await async_w3.bub.block_number
        block = await async_w3.bub.get_block("latest")
        assert block["number"] == current_block_number

    @pytest.mark.asyncio
    async def test_bub_getBlockByNumber_not_found(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        with pytest.raises(BlockNotFound):
            await async_w3.bub.get_block(BlockNumber(12345))

    @pytest.mark.asyncio
    async def test_bub_getBlockByNumber_pending(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        current_block_number = await async_w3.bub.block_number
        block = await async_w3.bub.get_block("pending")
    ...
    @pytest.mark.asyncio
    async def test_bub_getBlockByNumber_earliest(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        genesis_block = await async_w3.bub.get_block(BlockNumber(0))
        block = await async_w3.bub.get_block("earliest")
        assert block["number"] == 0
        assert block["hash"] == genesis_block["hash"]

    @pytest.mark.asyncio
    @pytest.mark.xfail(reason="Integration test suite not yet set up for PoS")
    async def test_bub_getBlockByNumber_safe(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        block = await async_w3.bub.get_block("safe")
        assert block is not None
        assert isinstance(block["number"], int)

    @pytest.mark.asyncio
    @pytest.mark.xfail(reason="Integration test suite not yet set up for PoS")
    async def test_bub_getBlockByNumber_finalized(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        block = await async_w3.bub.get_block("finalized")
        assert block is not None
        assert isinstance(block["number"], int)

    @pytest.mark.asyncio
    async def test_bub_get_block_by_number_full_transactions(
        self, async_w3: "AsyncWeb3", block_with_txn: BlockData
    ) -> None:
        block = await async_w3.bub.get_block(block_with_txn["number"], True)
        transaction = cast(TxData, block["transactions"][0])
        assert transaction["hash"] == block_with_txn["transactions"][0]

    @pytest.mark.asyncio
    async def test_bub_get_raw_transaction(
        self, async_w3: "AsyncWeb3", mined_txn_hash: HexStr
    ) -> None:
        raw_transaction = await async_w3.bub.get_raw_transaction(mined_txn_hash)
        assert is_bytes(raw_transaction)

    @pytest.mark.asyncio
    async def test_bub_get_raw_transaction_raises_error(
        self, async_w3: "AsyncWeb3"
    ) -> None:
        with pytest.raises(
            TransactionNotFound, match=f"Transaction with hash: '{UNKNOWN_HASH}'"
        ):
            await async_w3.bub.get_raw_transaction(UNKNOWN_HASH)

    @pytest.mark.asyncio
    async def test_bub_get_raw_transaction_by_block(
        self,
        async_w3: "AsyncWeb3",
        block_with_txn: BlockData,
        unlocked_account_dual_type: ChecksumAddress,
    ) -> None:
        # bub_getRawTransactionByBlockNumberAndIndex: block identifier
        # send a txn to make sure pending block has at least one txn
        await async_w3.bub.send_transaction(
            {
                "from": unlocked_account_dual_type,
                "to": unlocked_account_dual_type,
                "value": Wei(1),
        ...
        pending_block = await async_w3.bub.get_block("pending")
        last_pending_txn_index = len(pending_block["transactions"]) - 1
        raw_txn = await async_w3.bub.get_raw_transaction_by_block(
            "pending", last_pending_txn_index
        )
        assert is_bytes(raw_txn)

        # bub_getRawTransactionByBlockNumberAndIndex: block number
        block_with_txn_number = block_with_txn["number"]
        raw_transaction = await async_w3.bub.get_raw_transaction_by_block(
            block_with_txn_number, 0
        )
        assert is_bytes(raw_transaction)

        # bub_getRawTransactionByBlockHashAndIndex: block hash
    ...
    async def test_bub_get_raw_transaction_by_block_raises_error(
        ...
        with pytest.raises(
            ...
            await async_w3.bub.get_raw_transaction_by_block(
                unknown_block_num_or_hash, 0
            )

    @pytest.mark.asyncio
    async def test_bub_get_raw_transaction_by_block_raises_error_block_identifier(
        self, async_w3: "AsyncWeb3"
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bub_get_balance(self, async_w3: "AsyncWeb3") -> None:
        coinbase = await async_w3.bub.coinbase

        with pytest.raises(InvalidAddress):
            await async_w3.bub.get_balance(
                ChecksumAddress(HexAddress(HexStr(coinbase.lower())))
            )

        balance = await async_w3.bub.get_balance(coinbase)

        assert is_integer(balance)
        assert balance >= 0

    @pytest.mark.asyncio
    async def test_bub_get_code(
        self, async_w3: "AsyncWeb3", math_contract_address: ChecksumAddress
    ) -> None:
        code = await async_w3.bub.get_code(math_contract_address)
        assert isinstance(code, HexBytes)
        assert len(code) > 0

    @pytest.mark.asyncio
    async def test_bub_get_code_invalid_address(
        self,
        async_w3: "AsyncWeb3",
        math_contract: "Contract",
    ) -> None:
        with pytest.raises(InvalidAddress):
            await async_w3.bub.get_code(
                ChecksumAddress(HexAddress(HexStr(math_contract.address.lower())))
            )

    @pytest.mark.asyncio
    async def test_bub_get_code_with_block_identifier(
        self, async_w3: "AsyncWeb3", emitter_contract: "Contract"
    ) -> None:
        block_id = await async_w3.bub.block_number
        code = await async_w3.bub.get_code(emitter_contract.address, block_id)
        assert isinstance(code, HexBytes)
        assert len(code) > 0

    @pytest.mark.asyncio
    async def test_bub_get_transaction_count(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        transaction_count = await async_w3.bub.get_transaction_count(
    ...
    async def test_bub_call(
        ...
        call_result = await async_w3.bub.call(txn_params)
        assert is_string(call_result)
        (result,) = async_w3.codec.decode(["uint256"], call_result)
        assert result == 18

    @pytest.mark.asyncio
    async def test_bub_call_with_override_code(
        self,
        async_w3: "AsyncWeb3",
        ...
        call_result = await async_w3.bub.call(
        ...
        bytes_call_result = await async_w3.bub.call(
            txn_params,
            "latest",
    ...
    async def test_bub_call_with_override_param_type_check(
        self,
        async_w3: "AsyncWeb3",
        math_contract: "Contract",
        ...
        await async_w3.bub.call(txn_params, "latest", {math_contract.address: params})

    @pytest.mark.asyncio
    async def test_bub_call_with_0_result(
        self, async_w3: "AsyncWeb3", math_contract: "Contract"
    ) -> None:
        coinbase = await async_w3.bub.coinbase
        txn_params = math_contract._prepare_transaction(
    ...
    @pytest.mark.asyncio
    async def test_bub_call_revert_with_msg(
        self,
        async_w3: "AsyncWeb3",
        revert_contract: "Contract",
        ...
        with pytest.raises(
            ...
            await async_w3.bub.call(txn_params)

    @pytest.mark.asyncio
    async def test_bub_call_revert_without_msg(
        self,
        async_w3: "AsyncWeb3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_revert_custom_error_with_msg(
        self,
        async_w3: "AsyncWeb3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_revert_custom_error_without_msg(
        self,
        async_w3: "AsyncWeb3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup(
        self,
        async_w3: "AsyncWeb3",
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup_raises_when_ccip_read_is_disabled(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup_call_flag_overrides_provider_flag(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    async def test_bub_call_offchain_lookup_raises_if_max_redirects_is_less_than_4(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        max_redirects: int,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup_raises_for_improperly_formatted_rest_request_response(  # noqa: E501
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    async def test_bub_call_offchain_lookup_tries_next_url_for_non_4xx_error_status_and_tests_POST(  # noqa: E501
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup_calls_raise_for_status_for_4xx_status_code(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_bub_call_offchain_lookup_raises_when_all_supplied_urls_fail(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_bub_call_continuous_offchain_lookup_raises_with_too_many_requests(
        self,
        async_w3: "AsyncWeb3",
        async_offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_hashrate(self, async_w3: "AsyncWeb3") -> None:
        hashrate = await async_w3.bub.hashrate
        assert is_integer(hashrate)
        assert hashrate >= 0

    @pytest.mark.asyncio
    async def test_async_bub_chain_id(self, async_w3: "AsyncWeb3") -> None:
        chain_id = await async_w3.bub.chain_id
        # chain id value from bub fixture genesis file
        assert chain_id == 131277322940537

    @pytest.mark.asyncio
    async def test_async_bub_mining(self, async_w3: "AsyncWeb3") -> None:
        mining = await async_w3.bub.mining
        assert is_boolean(mining)

    @pytest.mark.asyncio
    async def test_async_bub_get_transaction_receipt_mined(
        self, async_w3: "AsyncWeb3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        receipt = await async_w3.bub.get_transaction_receipt(mined_txn_hash)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_get_transaction_receipt_unmined(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_hash = await async_w3.bub.send_transaction(
            {
                "from": unlocked_account_dual_type,
                "to": unlocked_account_dual_type,
                "value": Wei(1),
        ...
        with pytest.raises(TransactionNotFound):
            await async_w3.bub.get_transaction_receipt(txn_hash)

    @pytest.mark.asyncio
    async def test_async_bub_get_transaction_receipt_with_log_entry(
        self,
        async_w3: "AsyncWeb3",
        ...
        receipt = await async_w3.bub.wait_for_transaction_receipt(txn_hash_with_log)
        assert is_dict(receipt)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_wait_for_transaction_receipt_mined(
        self, async_w3: "AsyncWeb3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        receipt = await async_w3.bub.wait_for_transaction_receipt(mined_txn_hash)
        assert is_dict(receipt)
        assert receipt["blockNumber"] == block_with_txn["number"]
        assert receipt["blockHash"] == block_with_txn["hash"]
        assert receipt["transactionIndex"] == 0
    ...
    @pytest.mark.asyncio
    async def test_async_bub_wait_for_transaction_receipt_unmined(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_hash = await async_w3.bub.send_transaction(
            {
        ...
        with pytest.raises(TimeExhausted) as exc_info:
            await async_w3.bub.wait_for_transaction_receipt(txn_hash, timeout=timeout)

        assert (_ in str(exc_info) for _ in [repr(txn_hash), timeout])

    @pytest.mark.asyncio
    async def test_async_bub_wait_for_transaction_receipt_with_log_entry(
        self,
        async_w3: "AsyncWeb3",
        block_with_txn_with_log: BlockData,
        emitter_contract: "Contract",
    ...
    @pytest.mark.asyncio
    async def test_async_bub_accounts(self, async_w3: "AsyncWeb3") -> None:
        accounts = await async_w3.bub.accounts
        assert is_list_like(accounts)
        assert len(accounts) != 0
        assert all((is_checksum_address(account) for account in accounts))
        assert await async_w3.bub.coinbase in accounts

    @pytest.mark.asyncio
    async def test_async_bub_get_logs_without_logs(
        ...
        result = await async_w3.bub.get_logs(filter_params)
        assert len(result) == 0
    ...
    @pytest.mark.asyncio
    async def test_async_bub_get_logs_with_logs(
        self,
        async_w3: "AsyncWeb3",
        block_with_txn_with_log: BlockData,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_get_logs_with_logs_topic_args(
        self,
        async_w3: "AsyncWeb3",
        block_with_txn_with_log: BlockData,
        emitter_contract_address: ChecksumAddress,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_get_logs_with_logs_none_topic_args(
        self, async_w3: "AsyncWeb3"
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_async_bub_syncing(self, async_w3: "AsyncWeb3") -> None:
        syncing = await async_w3.bub.syncing
    ...
    @pytest.mark.asyncio
    async def test_async_bub_get_storage_at(
        self, async_w3: "AsyncWeb3", emitter_contract_address: ChecksumAddress
    ) -> None:
        storage = await async_w3.bub.get_storage_at(emitter_contract_address, 0)
        assert isinstance(storage, HexBytes)

    @pytest.mark.asyncio
    @pytest.mark.xfail
    async def test_async_bub_get_storage_at_ens_name(
        self, async_w3: "AsyncWeb3", emitter_contract_address: ChecksumAddress
    ) -> None:
        with ens_addresses(async_w3, {"emitter.bub": emitter_contract_address}):
            storage = await async_w3.bub.get_storage_at(ENS("emitter.bub"), 0)
            assert isinstance(storage, HexBytes)

    @pytest.mark.asyncio
    async def test_async_bub_get_storage_at_invalid_address(
        self, async_w3: "AsyncWeb3"
    ) -> None:
        coinbase = await async_w3.bub.coinbase
        with pytest.raises(InvalidAddress):
            await async_w3.bub.get_storage_at(
    ...
    def test_async_provider_default_account(
        ...
        default_account = async_w3.bub.default_account
        assert default_account is empty

        # check setter
        async_w3.bub.default_account = unlocked_account_dual_type
        default_account = async_w3.bub.default_account
        assert default_account == unlocked_account_dual_type

        # reset to default
        async_w3.bub.default_account = empty
    ...
    def test_async_provider_default_block(
        ...
        default_block = async_w3.bub.default_block
        assert default_block == "latest"

        # check setter
        async_w3.bub.default_block = BlockNumber(12345)
        default_block = async_w3.bub.default_block
        assert default_block == BlockNumber(12345)

        # reset to default
        async_w3.bub.default_block = "latest"

    @pytest.mark.asyncio
    async def test_bub_getBlockTransactionCountByHash_empty_block(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        transaction_count = await async_w3.bub.get_block_transaction_count(
            empty_block["hash"]
        )
    ...
    @pytest.mark.asyncio
    async def test_bub_getBlockTransactionCountByNumber_empty_block(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        transaction_count = await async_w3.bub.get_block_transaction_count(
            empty_block["number"]
    ...
    @pytest.mark.asyncio
    async def test_bub_getBlockTransactionCountByHash_block_with_txn(
        self, async_w3: "AsyncWeb3", block_with_txn: BlockData
    ) -> None:
        transaction_count = await async_w3.bub.get_block_transaction_count(
            block_with_txn["hash"]
    ...
    @pytest.mark.asyncio
    async def test_bub_getUncleCountByBlockHash(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        uncle_count = await async_w3.bub.get_uncle_count(empty_block["hash"])

        assert is_integer(uncle_count)
        assert uncle_count == 0

    @pytest.mark.asyncio
    async def test_bub_getUncleCountByBlockNumber(
        self, async_w3: "AsyncWeb3", empty_block: BlockData
    ) -> None:
        uncle_count = await async_w3.bub.get_uncle_count(empty_block["number"])

        assert is_integer(uncle_count)
        assert uncle_count == 0

    @pytest.mark.asyncio
    async def test_bub_getBlockTransactionCountByNumber_block_with_txn(
        self, async_w3: "AsyncWeb3", block_with_txn: BlockData
    ) -> None:
        transaction_count = await async_w3.bub.get_block_transaction_count(
    ...
    @pytest.mark.asyncio
    async def test_async_bub_sign(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        signature = await async_w3.bub.sign(
        ...
        # test other formats
        hexsign = await async_w3.bub.sign(
            unlocked_account_dual_type,
            hexstr=HexStr(
    ...
    async def test_async_bub_sign_ens_names(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        with ens_addresses(async_w3, {"unlocked-acct.bub": unlocked_account_dual_type}):
            signature = await async_w3.bub.sign(
                ENS("unlocked-acct.bub"), text="Message tö sign. Longer than hash!"
            )
            assert is_bytes(signature)
            assert len(signature) == 32 + 32 + 1

    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_legacy(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        replace_txn_hash = await async_w3.bub.replace_transaction(txn_hash, txn_params)
        replace_txn = await async_w3.bub.get_transaction(replace_txn_hash)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        two_gwei_in_wei = async_w3.to_wei(2, "gwei")
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_underpriced(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        with pytest.raises(ValueError, match="replacement transaction underpriced"):
            await async_w3.bub.replace_transaction(txn_hash, txn_params)

    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_non_existing_transaction(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        with pytest.raises(TransactionNotFound):
            await async_w3.bub.replace_transaction(
                HexStr(
    ...
    @pytest.mark.asyncio
    @pytest.mark.xfail(reason="AsyncNodeMiner is missing.")
    async def test_async_bub_replace_transaction_already_mined(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        txn_hash = await async_w3.bub.send_transaction(txn_params)
        try:
            async_w3.bub.miner.start()  # type: ignore
            await async_w3.bub.wait_for_transaction_receipt(txn_hash, timeout=10)
        finally:
            async_w3.bub.miner.stop()  # type: ignore
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_incorrect_nonce(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_gas_price_too_low(
        self, async_w3: "AsyncWeb3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_gas_price_defaulting_minimum(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_gas_price_defaulting_strategy_higher(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
        ...
        async_w3.bub.set_gas_price_strategy(higher_gas_price_strategy)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_replace_transaction_gas_price_defaulting_strategy_lower(
        self, async_w3: "AsyncWeb3", unlocked_account: ChecksumAddress
    ) -> None:
        ...
        async_w3.bub.set_gas_price_strategy(lower_gas_price_strategy)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_new_filter(self, async_w3: "AsyncWeb3") -> None:
        filter = await async_w3.bub.filter({})

        changes = await async_w3.bub.get_filter_changes(filter.filter_id)
        assert is_list_like(changes)
        assert not changes

        logs = await async_w3.bub.get_filter_logs(filter.filter_id)
        assert is_list_like(logs)
        assert not logs

        result = await async_w3.bub.uninstall_filter(filter.filter_id)
        assert result is True

    @pytest.mark.asyncio
    async def test_async_bub_new_block_filter(self, async_w3: "AsyncWeb3") -> None:
        filter = await async_w3.bub.filter("latest")
    ...
    @pytest.mark.asyncio
    async def test_async_bub_new_pending_transaction_filter(
        self, async_w3: "AsyncWeb3"
    ) -> None:
        filter = await async_w3.bub.filter("pending")
        assert is_string(filter.filter_id)
    ...
    @pytest.mark.asyncio
    async def test_async_bub_uninstall_filter(self, async_w3: "AsyncWeb3") -> None:
        filter = await async_w3.bub.filter({})
        assert is_string(filter.filter_id)

        success = await async_w3.bub.uninstall_filter(filter.filter_id)
        assert success is True

        failure = await async_w3.bub.uninstall_filter(filter.filter_id)
        assert failure is False


class EthModuleTest:
    def test_bub_syncing(self, w3: "Web3") -> None:
        syncing = w3.bub.syncing
    ...
    def test_bub_coinbase(self, w3: "Web3") -> None:
        coinbase = w3.bub.coinbase
        assert is_checksum_address(coinbase)

    def test_bub_mining(self, w3: "Web3") -> None:
        mining = w3.bub.mining
        assert is_boolean(mining)

    def test_bub_hashrate(self, w3: "Web3") -> None:
        hashrate = w3.bub.hashrate
        assert is_integer(hashrate)
        assert hashrate >= 0

    def test_bub_chain_id(self, w3: "Web3") -> None:
        chain_id = w3.bub.chain_id
        # chain id value from bub fixture genesis file
        assert chain_id == 131277322940537

    def test_bub_fee_history(self, w3: "Web3") -> None:
        fee_history = w3.bub.fee_history(1, "latest", [50])
        assert is_list_like(fee_history["baseFeePerGas"])
        assert is_list_like(fee_history["gasUsedRatio"])
        assert is_integer(fee_history["oldestBlock"])
        assert fee_history["oldestBlock"] >= 0
    ...
    def test_bub_fee_history_with_integer(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        fee_history = w3.bub.fee_history(1, empty_block["number"], [50])
        assert is_list_like(fee_history["baseFeePerGas"])
        assert is_list_like(fee_history["gasUsedRatio"])
        assert is_integer(fee_history["oldestBlock"])
        assert fee_history["oldestBlock"] >= 0
    ...
    def test_bub_fee_history_no_reward_percentiles(self, w3: "Web3") -> None:
        fee_history = w3.bub.fee_history(1, "latest")
        assert is_list_like(fee_history["baseFeePerGas"])
        assert is_list_like(fee_history["gasUsedRatio"])
        assert is_integer(fee_history["oldestBlock"])
        assert fee_history["oldestBlock"] >= 0

    def test_bub_gas_price(self, w3: "Web3") -> None:
        gas_price = w3.bub.gas_price
        assert is_integer(gas_price)
        assert gas_price > 0

    def test_bub_max_priority_fee(self, w3: "Web3") -> None:
        max_priority_fee = w3.bub.max_priority_fee
        assert is_integer(max_priority_fee)

    def test_bub_max_priority_fee_with_fee_history_calculation(
        self, w3: "Web3"
    ) -> None:
    ...
    def test_bub_accounts(self, w3: "Web3") -> None:
        accounts = w3.bub.accounts
        assert is_list_like(accounts)
        assert len(accounts) != 0
        assert all((is_checksum_address(account) for account in accounts))
        assert w3.bub.coinbase in accounts

    def test_bub_block_number(self, w3: "Web3") -> None:
        block_number = w3.bub.block_number
        assert is_integer(block_number)
        assert block_number >= 0

    def test_bub_get_block_number(self, w3: "Web3") -> None:
        block_number = w3.bub.get_block_number()
        assert is_integer(block_number)
        assert block_number >= 0

    def test_bub_get_balance(self, w3: "Web3") -> None:
        coinbase = w3.bub.coinbase

        with pytest.raises(InvalidAddress):
            w3.bub.get_balance(ChecksumAddress(HexAddress(HexStr(coinbase.lower()))))

        balance = w3.bub.get_balance(coinbase)
    ...
    @pytest.mark.parametrize(
        ...
        [("test-address.bub", True), ("not-an-address.bub", False)],
    )
    def test_bub_get_balance_with_ens_name(
        self, w3: "Web3", address: ChecksumAddress, expect_success: bool
    ) -> None:
        with ens_addresses(w3, {"test-address.bub": w3.bub.accounts[0]}):
            if expect_success:
                balance = w3.bub.get_balance(address)
                assert is_integer(balance)
                assert balance >= 0
            else:
                with pytest.raises(NameNotFound):
                    w3.bub.get_balance(address)

    def test_bub_get_storage_at(
        self, w3: "Web3", emitter_contract_address: ChecksumAddress
    ) -> None:
        storage = w3.bub.get_storage_at(emitter_contract_address, 0)
        assert isinstance(storage, HexBytes)

    def test_bub_get_storage_at_ens_name(
        self, w3: "Web3", emitter_contract_address: ChecksumAddress
    ) -> None:
        with ens_addresses(w3, {"emitter.bub": emitter_contract_address}):
            storage = w3.bub.get_storage_at(ENS("emitter.bub"), 0)
            assert isinstance(storage, HexBytes)

    def test_bub_get_storage_at_invalid_address(self, w3: "Web3") -> None:
        coinbase = w3.bub.coinbase
        with pytest.raises(InvalidAddress):
            w3.bub.get_storage_at(
                ChecksumAddress(HexAddress(HexStr(coinbase.lower()))), 0
            )

    def test_bub_get_transaction_count(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        transaction_count = w3.bub.get_transaction_count(unlocked_account_dual_type)
        assert is_integer(transaction_count)
        assert transaction_count >= 0

    def test_bub_get_transaction_count_ens_name(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        with ens_addresses(
            w3, {"unlocked-acct-dual-type.bub": unlocked_account_dual_type}
        ):
            transaction_count = w3.bub.get_transaction_count(
                ENS("unlocked-acct-dual-type.bub")
            )
            assert is_integer(transaction_count)
            assert transaction_count >= 0

    def test_bub_get_transaction_count_invalid_address(self, w3: "Web3") -> None:
        coinbase = w3.bub.coinbase
        with pytest.raises(InvalidAddress):
    ...
    def test_bub_getBlockTransactionCountByHash_empty_block(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        transaction_count = w3.bub.get_block_transaction_count(empty_block["hash"])

        assert is_integer(transaction_count)
        assert transaction_count == 0

    def test_bub_getBlockTransactionCountByNumber_empty_block(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        transaction_count = w3.bub.get_block_transaction_count(empty_block["number"])

        assert is_integer(transaction_count)
        assert transaction_count == 0

    def test_bub_getBlockTransactionCountByHash_block_with_txn(
        self, w3: "Web3", block_with_txn: BlockData
    ) -> None:
        transaction_count = w3.bub.get_block_transaction_count(block_with_txn["hash"])

        assert is_integer(transaction_count)
        assert transaction_count >= 1

    def test_bub_getBlockTransactionCountByNumber_block_with_txn(
        self, w3: "Web3", block_with_txn: BlockData
    ) -> None:
        transaction_count = w3.bub.get_block_transaction_count(block_with_txn["number"])

        assert is_integer(transaction_count)
        assert transaction_count >= 1

    def test_bub_getUncleCountByBlockHash(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        uncle_count = w3.bub.get_uncle_count(empty_block["hash"])

        assert is_integer(uncle_count)
        assert uncle_count == 0

    def test_bub_getUncleCountByBlockNumber(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        uncle_count = w3.bub.get_uncle_count(empty_block["number"])

        assert is_integer(uncle_count)
        assert uncle_count == 0

    def test_bub_get_code(
        self, w3: "Web3", math_contract_address: ChecksumAddress
    ) -> None:
        code = w3.bub.get_code(math_contract_address)
        assert isinstance(code, HexBytes)
        assert len(code) > 0

    def test_bub_get_code_ens_address(
        self, w3: "Web3", math_contract_address: ChecksumAddress
    ) -> None:
        with ens_addresses(w3, {"mathcontract.bub": math_contract_address}):
            code = w3.bub.get_code(ENS("mathcontract.bub"))
            assert isinstance(code, HexBytes)
            assert len(code) > 0

    def test_bub_get_code_invalid_address(
    ...
    def test_bub_get_code_with_block_identifier(
        self, w3: "Web3", emitter_contract: "Contract"
    ) -> None:
        code = w3.bub.get_code(
            emitter_contract.address, block_identifier=w3.bub.block_number
        )
        assert isinstance(code, HexBytes)
        assert len(code) > 0
    ...
    def test_bub_sign(
        ...
        bytessign = w3.bub.sign(
            unlocked_account_dual_type, b"Message t\xc3\xb6 sign. Longer than hash!"
        )
        assert bytessign == signature

        new_signature = w3.bub.sign(
            unlocked_account_dual_type, text="different message is different"
        )
        assert new_signature != signature

    def test_bub_sign_ens_names(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        with ens_addresses(w3, {"unlocked-acct.bub": unlocked_account_dual_type}):
            signature = w3.bub.sign(
                "unlocked-acct.bub", text="Message tö sign. Longer than hash!"
            )
            assert is_bytes(signature)
            assert len(signature) == 32 + 32 + 1

    def test_bub_sign_typed_data(
        self,
        w3: "Web3",
        unlocked_account_dual_type: ChecksumAddress,
        ...
        skip_if_testrpc(w3)
        signature = HexBytes(
            w3.bub.sign_typed_data(
                unlocked_account_dual_type, json.loads(validJSONMessage)
            )
        )
        assert len(signature) == 32 + 32 + 1

    def test_invalid_bub_sign_typed_data(
        self,
        w3: "Web3",
        unlocked_account_dual_type: ChecksumAddress,
        skip_if_testrpc: Callable[["Web3"], None],
    ...
    def test_bub_sign_transaction_legacy(
        ...
        txn_params: TxParams = {
            ...
            "value": Wei(1),
            "gas": 21000,
            "gasPrice": w3.bub.gas_price,
            "nonce": Nonce(0),
        }
        result = w3.bub.sign_transaction(txn_params)
        signatory_account = w3.bub.account.recover_transaction(result["raw"])
        assert unlocked_account == signatory_account
        assert result["tx"]["to"] == txn_params["to"]
        assert result["tx"]["value"] == txn_params["value"]
        assert result["tx"]["gas"] == txn_params["gas"]
    ...
    def test_bub_sign_transaction_hex_fees(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    def test_bub_sign_transaction_ens_names(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        with ens_addresses(w3, {"unlocked-account.bub": unlocked_account}):
            txn_params: TxParams = {
                "from": "unlocked-account.bub",
                "to": "unlocked-account.bub",
                "value": Wei(1),
    ...
    def test_bub_send_transaction_addr_checksum_required(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        ...
        with pytest.raises(InvalidAddress):
            ...
            w3.bub.send_transaction(invalid_params)
    ...
    def test_bub_send_transaction_legacy(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        txn_hash = w3.bub.send_transaction(txn_params)
    ...
    def test_bub_send_transaction_with_nonce(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        ...
        txn_params: TxParams = {
            ...
            "maxPriorityFeePerGas": w3.to_wei(1, "gwei"),
            "nonce": w3.bub.get_transaction_count(unlocked_account),
        }
        txn_hash = w3.bub.send_transaction(txn_params)
        txn = w3.bub.get_transaction(txn_hash)
    ...
    def test_bub_send_transaction_default_fees(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_bub_send_transaction_hex_fees(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_bub_send_transaction_no_gas(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_bub_send_transaction_with_gas_price(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        with pytest.raises(TransactionTypeMismatch):
            w3.bub.send_transaction(txn_params)

    def test_bub_send_transaction_no_priority_fee(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_bub_send_transaction_no_max_fee(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    def test_bub_send_transaction_max_fee_less_than_tip(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_validation_middleware_chain_id_mismatch(
        ...
        wrong_chain_id = 1234567890
        actual_chain_id = w3.bub.chain_id
    ...
    def test_gas_price_from_strategy_bypassed_for_dynamic_fee_txn(
        ...
        w3.bub.set_gas_price_strategy(None)  # reset strategy
    ...
    def test_bub_replace_transaction_legacy(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        replace_txn_hash = w3.bub.replace_transaction(txn_hash, txn_params)
        replace_txn = w3.bub.get_transaction(replace_txn_hash)
    ...
    def test_bub_replace_transaction(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
    ...
    def test_bub_replace_transaction_underpriced(
        ...
        with pytest.raises(ValueError, match="replacement transaction underpriced"):
            w3.bub.replace_transaction(txn_hash, txn_params)

    def test_bub_replace_transaction_non_existing_transaction(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
    ...
    def test_bub_replace_transaction_already_mined(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account_dual_type,
        ...
        txn_hash = w3.bub.send_transaction(txn_params)
        try:
            w3.bub.miner.start()  # type: ignore
            w3.bub.wait_for_transaction_receipt(txn_hash, timeout=10)
        finally:
            w3.bub.miner.stop()  # type: ignore
    ...
    def test_bub_modify_transaction_legacy(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
        ...
        modified_txn_hash = w3.bub.modify_transaction(
            txn_hash, gasPrice=(cast(int, txn_params["gasPrice"]) * 2), value=2
        )
        modified_txn = w3.bub.get_transaction(modified_txn_hash)
    ...
    def test_bub_modify_transaction(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        txn_params: TxParams = {
            "from": unlocked_account,
    ...
    def test_bub_send_raw_transaction(
        self, w3: "Web3", unlocked_account: ChecksumAddress
    ) -> None:
        signed_tx = w3.bub.account.sign_transaction(
            {
        ...
        txn_hash = w3.bub.send_raw_transaction(signed_tx.rawTransaction)
        assert txn_hash == signed_tx.hash

    def test_bub_call(self, w3: "Web3", math_contract: "Contract") -> None:
        coinbase = w3.bub.coinbase
        txn_params = math_contract._prepare_transaction(
            fn_name="add",
            fn_args=(7, 11),
        ...
        call_result = w3.bub.call(txn_params)
        assert is_string(call_result)
        (result,) = w3.codec.decode(["uint256"], call_result)
        assert result == 18

    def test_bub_call_with_override_code(
    ...
    def test_bub_call_with_override_param_type_check(
        self,
        w3: "Web3",
        math_contract: "Contract",
        params: CallOverrideParams,
    ) -> None:
        txn_params: TxParams = {"from": w3.bub.coinbase}

        # assert does not raise
        w3.bub.call(txn_params, "latest", {math_contract.address: params})

    def test_bub_call_with_0_result(
        self, w3: "Web3", math_contract: "Contract"
    ) -> None:
        coinbase = w3.bub.coinbase
        txn_params = math_contract._prepare_transaction(
    ...
    def test_bub_call_revert_with_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_call_revert_without_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_call_custom_error_revert_with_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_call_custom_error_revert_without_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_call_offchain_lookup(
        self,
        w3: "Web3",
    ...
    def test_bub_call_offchain_lookup_call_flag_overrides_provider_flag(
        self,
        w3: "Web3",
        offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    @pytest.mark.parametrize("max_redirects", range(-1, 4))
    def test_bub_call_offchain_lookup_raises_if_max_redirects_is_less_than_4(
        self,
        w3: "Web3",
        offchain_lookup_contract: "Contract",
        max_redirects: int,
    ...
    def test_bub_call_offchain_lookup_raises_for_improperly_formatted_rest_request_response(  # noqa: E501
        self,
        w3: "Web3",
        offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_call_offchain_lookup_raises_when_all_supplied_urls_fail(
        self,
        w3: "Web3",
        offchain_lookup_contract: "Contract",
    ) -> None:
    ...
    def test_bub_call_continuous_offchain_lookup_raises_with_too_many_requests(
        self,
        w3: "Web3",
        offchain_lookup_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_estimate_gas_custom_error_revert_with_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_estimate_gas_custom_error_revert_without_msg(
        self,
        w3: "Web3",
        revert_contract: "Contract",
        unlocked_account: ChecksumAddress,
    ...
    def test_bub_estimate_gas(
        ...
        gas_estimate = w3.bub.estimate_gas(
            {
                "from": unlocked_account_dual_type,
                "to": unlocked_account_dual_type,
                "value": Wei(1),
    ...
    def test_bub_getBlockByHash(self, w3: "Web3", empty_block: BlockData) -> None:
        block = w3.bub.get_block(empty_block["hash"])
        assert block["hash"] == empty_block["hash"]
        assert block["receiptsRoot"] == empty_block["receiptsRoot"]
        assert block["logsBloom"] == empty_block["logsBloom"]

    def test_bub_getBlockByHash_not_found(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        with pytest.raises(BlockNotFound):
            w3.bub.get_block(UNKNOWN_HASH)

    def test_bub_getBlockByHash_pending(self, w3: "Web3") -> None:
        block = w3.bub.get_block("pending")
        assert block["hash"] is None

    def test_bub_getBlockByNumber_with_integer(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        block = w3.bub.get_block(empty_block["number"])
        assert block["number"] == empty_block["number"]

    def test_bub_getBlockByNumber_latest(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        current_block_number = w3.bub.block_number
        block = w3.bub.get_block("latest")
        assert block["number"] == current_block_number

    def test_bub_getBlockByNumber_not_found(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        with pytest.raises(BlockNotFound):
            w3.bub.get_block(BlockNumber(12345))

    def test_bub_getBlockByNumber_pending(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        current_block_number = w3.bub.block_number
        block = w3.bub.get_block("pending")
    ...
    def test_bub_getBlockByNumber_earliest(
        self, w3: "Web3", empty_block: BlockData
    ) -> None:
        genesis_block = w3.bub.get_block(BlockNumber(0))
    ...
    def test_bub_getBlockByNumber_finalized(
        ...
        block = w3.bub.get_block("finalized")
        assert block is not None
        assert isinstance(block["number"], int)

    def test_bub_getBlockByNumber_full_transactions(
        self, w3: "Web3", block_with_txn: BlockData
    ) -> None:
        block = w3.bub.get_block(block_with_txn["number"], True)
        transaction = block["transactions"][0]
        assert transaction["hash"] == block_with_txn["transactions"][0]  # type: ignore

    def test_bub_getTransactionByHash(self, w3: "Web3", mined_txn_hash: HexStr) -> None:
        transaction = w3.bub.get_transaction(mined_txn_hash)
        assert is_dict(transaction)
        assert transaction["hash"] == HexBytes(mined_txn_hash)

    def test_bub_getTransactionByHash_contract_creation(
        self, w3: "Web3", math_contract_deploy_txn_hash: HexStr
    ) -> None:
        transaction = w3.bub.get_transaction(math_contract_deploy_txn_hash)
        assert is_dict(transaction)
        assert transaction["to"] is None, f"to field is {transaction['to']!r}"

    def test_bub_getTransactionByBlockHashAndIndex(
        self, w3: "Web3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        transaction = w3.bub.get_transaction_by_block(block_with_txn["hash"], 0)
        assert is_dict(transaction)
        assert transaction["hash"] == HexBytes(mined_txn_hash)

    def test_bub_getTransactionByBlockNumberAndIndex(
        self, w3: "Web3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        transaction = w3.bub.get_transaction_by_block(block_with_txn["number"], 0)
        assert is_dict(transaction)
        assert transaction["hash"] == HexBytes(mined_txn_hash)

    def test_bub_get_transaction_receipt_mined(
        self, w3: "Web3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        receipt = w3.bub.get_transaction_receipt(mined_txn_hash)
        assert is_dict(receipt)
        assert receipt["blockNumber"] == block_with_txn["number"]
        assert receipt["blockHash"] == block_with_txn["hash"]
        assert receipt["transactionIndex"] == 0
    ...
    def test_bub_get_transaction_receipt_with_log_entry(
        self,
        w3: "Web3",
        block_with_txn_with_log: BlockData,
        emitter_contract: "Contract",
        ...
        receipt = w3.bub.get_transaction_receipt(txn_hash_with_log)
        assert is_dict(receipt)
        assert receipt["blockNumber"] == block_with_txn_with_log["number"]
        assert receipt["blockHash"] == block_with_txn_with_log["hash"]
        assert receipt["transactionIndex"] == 0
    ...
    def test_bub_wait_for_transaction_receipt_mined(
        self, w3: "Web3", block_with_txn: BlockData, mined_txn_hash: HexStr
    ) -> None:
        receipt = w3.bub.wait_for_transaction_receipt(mined_txn_hash)
        assert is_dict(receipt)
        assert receipt["blockNumber"] == block_with_txn["number"]
        assert receipt["blockHash"] == block_with_txn["hash"]
        assert receipt["transactionIndex"] == 0
    ...
    def test_bub_wait_for_transaction_receipt_unmined(
        ...
        timeout = 2
        with pytest.raises(TimeExhausted) as exc_info:
            w3.bub.wait_for_transaction_receipt(txn_hash, timeout=timeout)

        assert (_ in str(exc_info) for _ in [repr(txn_hash), timeout])

    def test_bub_wait_for_transaction_receipt_with_log_entry(
        self,
        w3: "Web3",
        block_with_txn_with_log: BlockData,
        emitter_contract: "Contract",
        ...
        receipt = w3.bub.wait_for_transaction_receipt(txn_hash_with_log)
        assert is_dict(receipt)
        assert receipt["blockNumber"] == block_with_txn_with_log["number"]
        assert receipt["blockHash"] == block_with_txn_with_log["hash"]
        assert receipt["transactionIndex"] == 0
    ...
    def test_bub_getUncleByBlockHashAndIndexctionReceipt(self, w3: "Web3") -> None:
        # TODO: how do we make uncles....
        pass

    def test_bub_getUncleByBlockNumberAndIndex(self, w3: "Web3") -> None:
        # TODO: how do we make uncles....
        pass

    def test_bub_new_filter(self, w3: "Web3") -> None:
        filter = w3.bub.filter({})

        changes = w3.bub.get_filter_changes(filter.filter_id)
        assert is_list_like(changes)
        assert not changes

        logs = w3.bub.get_filter_logs(filter.filter_id)
        assert is_list_like(logs)
        assert not logs

        result = w3.bub.uninstall_filter(filter.filter_id)
        assert result is True

    def test_bub_new_block_filter(self, w3: "Web3") -> None:
        filter = w3.bub.filter("latest")
        assert is_string(filter.filter_id)
    ...
    def test_bub_new_pending_transaction_filter(self, w3: "Web3") -> None:
        filter = w3.bub.filter("pending")
        assert is_string(filter.filter_id)
    ...
    def test_bub_get_logs_without_logs(
        ...
        result = w3.bub.get_logs(filter_params)
        assert len(result) == 0
    ...
    def test_bub_get_logs_with_logs(
        self,
        w3: "Web3",
        block_with_txn_with_log: BlockData,
        emitter_contract_address: ChecksumAddress,
    ...
    def test_bub_get_logs_with_logs_topic_args(
        self,
        w3: "Web3",
        block_with_txn_with_log: BlockData,
        emitter_contract_address: ChecksumAddress,
    ...
    def test_bub_get_logs_with_logs_none_topic_args(self, w3: "Web3") -> None:
        # Test with None overflowing
        filter_params: FilterParams = {
            "fromBlock": BlockNumber(0),
            "topics": [None, None, None],
    ...
    def test_bub_call_old_contract_state(
        ...
        start_block = w3.bub.get_block("latest")
    ...
    def test_bub_uninstall_filter(self, w3: "Web3") -> None:
        filter = w3.bub.filter({})
        assert is_string(filter.filter_id)

        success = w3.bub.uninstall_filter(filter.filter_id)
        assert success is True

        failure = w3.bub.uninstall_filter(filter.filter_id)
        assert failure is False

    def test_bub_submit_hashrate(self, w3: "Web3") -> None:
        ...
        result = w3.bub.submit_hashrate(5000, node_id)
        assert result is True

    def test_bub_submit_work(self, w3: "Web3") -> None:
        nonce = 1
        pow_hash = HexStr(
        ...
        result = w3.bub.submit_work(nonce, pow_hash, mix_digest)
        assert result is False

    def test_bub_get_raw_transaction(self, w3: "Web3", mined_txn_hash: HexStr) -> None:
        raw_transaction = w3.bub.get_raw_transaction(mined_txn_hash)
        assert is_bytes(raw_transaction)

    def test_bub_get_raw_transaction_raises_error(self, w3: "Web3") -> None:
        with pytest.raises(
            TransactionNotFound, match=f"Transaction with hash: '{UNKNOWN_HASH}'"
        ):
            w3.bub.get_raw_transaction(UNKNOWN_HASH)
    ...
    def test_bub_get_raw_transaction_by_block(
        ...
        last_pending_txn_index = len(w3.bub.get_block("pending")["transactions"]) - 1
        raw_transaction = w3.bub.get_raw_transaction_by_block(
            "pending", last_pending_txn_index
        )
        assert is_bytes(raw_transaction)
        ...
        raw_transaction = w3.bub.get_raw_transaction_by_block(block_with_txn_number, 0)
        assert is_bytes(raw_transaction)

        # bub_getRawTransactionByBlockHashAndIndex: block hash
        block_with_txn_hash = block_with_txn["hash"]
        assert is_bytes(block_with_txn_hash)
        raw_transaction = w3.bub.get_raw_transaction_by_block(block_with_txn_hash, 0)
        assert is_bytes(raw_transaction)

    @pytest.mark.parametrize("unknown_block_num_or_hash", (1234567899999, UNKNOWN_HASH))
    def test_bub_get_raw_transaction_by_block_raises_error(
        ...
        with pytest.raises(
            ...
            w3.bub.get_raw_transaction_by_block(unknown_block_num_or_hash, 0)

    def test_bub_get_raw_transaction_by_block_raises_error_block_identifier(
        self, w3: "Web3"
    ) -> None:
        unknown_identifier = "unknown"
        with pytest.raises(
            ...
            w3.bub.get_raw_transaction_by_block(unknown_identifier, 0)  # type: ignore

    def test_default_account(
        self, w3: "Web3", unlocked_account_dual_type: ChecksumAddress
    ) -> None:
        # check defaults to empty
        default_account = w3.bub.default_account
        assert default_account is empty

        # check setter
        w3.bub.default_account = unlocked_account_dual_type
        default_account = w3.bub.default_account
        assert default_account == unlocked_account_dual_type

        # reset to default
        w3.bub.default_account = empty
    ...
    def test_default_block(
        ...
        # check defaults to 'latest'
        default_block = w3.bub.default_block
        assert default_block == "latest"

        # check setter
        w3.bub.default_block = BlockNumber(12345)
        default_block = w3.bub.default_block
        assert default_block == BlockNumber(12345)

        # reset to default
        w3.bub.default_block = "latest"
