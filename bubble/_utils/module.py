...
if TYPE_CHECKING:
    from bubble.main import BaseWeb3  # noqa: F401
    ...
    for module_name, module_info in module_definitions.items():
        ...
        if hasattr(parent_module, module_name):
            raise AttributeError(
                ...
                " The bubble object already has an attribute with that name"
            )
        ...
        if len(module_init_params) == 1:
            ...
            # case for any module that inherits from ``bubble.module.Module``.
