...
to_hexstr_from_bub_key = operator.methodcaller("to_hex")


def is_bub_key(value: Any) -> bool:
    return isinstance(value, PrivateKey)


key_normalizer = compose(
    apply_formatter_if(is_bub_key, to_hexstr_from_bub_key),
)
...
def construct_sign_and_send_raw_middleware(
    ...
    def sign_and_send_raw_middleware(
        ...
        def middleware(method: RPCEndpoint, params: Any) -> RPCResponse:
            ...
            return make_request(RPCEndpoint("bub_sendRawTransaction"), [raw_tx])
