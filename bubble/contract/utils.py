    ...
    **kwargs: Any,
    ...
    try:
        ...
        is_missing_code_error = (
            ...
            and w3.bub.get_code(address) in ACCEPTABLE_EMPTY_STRINGS
        )
...
def transact_with_contract_function(
    ...
    **kwargs: Any,
    ...
    txn_hash = w3.bub.send_transaction(transact_transaction)
    return txn_hash
...
def estimate_gas_for_function(
    ...
    **kwargs: Any,
    ...
    return w3.bub.estimate_gas(estimate_transaction, block_identifier)
...
async def async_call_contract_function(
    ...
    **kwargs: Any,
    ...
    return_data = await async_w3.bub.call(
        call_transaction,
        block_identifier=block_id,
        state_override=state_override,
        ccip_read_enabled=ccip_read_enabled,
    ...
    try:
        ...
        is_missing_code_error = (
            return_data in ACCEPTABLE_EMPTY_STRINGS
            and await async_w3.bub.get_code(address) in ACCEPTABLE_EMPTY_STRINGS
        )
        if is_missing_code_error:
            msg = (
                "Could not transact with/call contract function, is contract "
...
async def async_transact_with_contract_function(
    ...
    **kwargs: Any,
    ...
    txn_hash = await async_w3.bub.send_transaction(transact_transaction)
    return txn_hash
...
async def async_estimate_gas_for_function(
    ...
    **kwargs: Any,
    ...
    return await async_w3.bub.estimate_gas(estimate_transaction, block_identifier)
