...
class BaseContract:
    ...
    :meth:`bubble.bub.Bub.contract` that takes compiled Solidity contract
...
class BaseContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <bubble.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'bubble._utils.datatypes.LogAnonymous'>
        ...
...
class BaseContractCaller:
    ...
    > contract.caller({'from': bub.accounts[1], 'gas': 100000, ...}).add(2, 3)
    is equivalent to this call in the classic contract:
    > contract.functions.add(2, 3).call({'from': bub.accounts[1], 'gas': 100000, ...})
    ...
    > contract.caller(transaction={'from': bub.accounts[1], 'gas': 100000, ...}).add(2, 3)  # noqa: E501
    """
